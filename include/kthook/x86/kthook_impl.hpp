...
#endif
            void* relay_ptr = reinterpret_cast<void*>(&detail::relay_generator<kthook_simple, function::convention, Ret, Args>::relay);
            if constexpr (function::convention == detail::traits::cconv::ccdecl) {
...
#pragma pack(pop)
                if (!this->relay_jump) {
                    ...
                    uintptr_t relative = detail::get_relative_address(reinterpret_cast<std::uintptr_t>(this->relay_jump), info.hook_address);
